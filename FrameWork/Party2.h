...
class CParty2 : public CGameObject
{
protected:
...
class CSoundCallbackHandlerParty2 : public CAnimationCallbackHandler
{
public:
	CSoundCallbackHandlerParty2() { }
	~CSoundCallbackHandlerParty2() { }
...
class CAngrybotParty2 : public CParty2
{
public:
	CAngrybotParty2(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, void* pContext = NULL);
	virtual ~CAngrybotParty2();
