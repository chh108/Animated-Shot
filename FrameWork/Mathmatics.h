...
namespace Matrix4x4
{
	...
	inline XMFLOAT4X4 Add(XMFLOAT4X4& xmmtx4x4Matrix1, XMFLOAT4X4& xmmtx4x4Matrix2, float fScale)
	{
		XMFLOAT4X4 xmf4x4Result;
		XMStoreFloat4x4(&xmf4x4Result, XMLoadFloat4x4(&xmmtx4x4Matrix1) + (XMLoadFloat4x4(&xmmtx4x4Matrix2) * fScale));
		return(xmf4x4Result);
	}
	...
	inline XMFLOAT4X4 LookAtLH(XMFLOAT3& xmf3EyePosition, const XMFLOAT3& xmf3LookAtPosition, XMFLOAT3& xmf3UpDirection)
	{
		XMFLOAT4X4 xmf4x4Result;
